...
cat("The number of total parameters is ",n.allpar,".","\n",sep="")
...
if (setalpha0.to.0==TRUE){
  part1.results=.part1noa0(no.cases=n, no.controls.per.set=capm, y=y,
                      sv=sv,w=w,xs=xs,z=z,startingvalues=startingvalues2,len.xs=len.xs,len.sv=len.sv
                      ,len.z=len.z,no.par.one=no.par.one,no.par.two=no.par.two,nallpara=nallpara)
  #
  ...
  part1.results=.part1noa1(no.cases=n, no.controls.per.set=capm, y=y,
                      sv=sv,w=w,xs=xs,z=z,startingvalues=startingvalues2,len.xs=len.xs,len.sv=len.sv
                      ,len.z=len.z,no.par.one=no.par.one,no.par.two=no.par.two,nallpara=nallpara)
  #
  #Grab results and store for subsequent functions
...
#Run function part2
cat("Estimating the beta parameters...","\n")
if(setalpha0.to.0==TRUE){
part2.results=.part2noa0(y=y,sv=sv,w=w,xs=xs,z=z,prt1_1=prt1_1,
                    alpha.1.1=alpha.1.1,prw1_1=prw1_1,
                    naiveestimate=naive.estimate.beta,len.xs=len.xs,
                    len.sv=len.sv,len.z=len.z,no.par.one=no.par.one,
                    no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)
} else if (setalpha1.to.0==TRUE) {
  part2.results=.part2noa1(y=y,sv=sv,w=w,xs=xs,z=z,prt1_1=prt1_1,
                      alpha.0.1=alpha.0.1,prw1_1=prw1_1,
                      naiveestimate=naive.estimate.beta,len.xs=len.xs,
                      len.sv=len.sv,len.z=len.z,no.par.one=no.par.one,
                      no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)  
} else  {
...
#Run function part3
cat("Estimating standard errors of the estimates...","\n")
allpara=c(par.set,beta)
nallpara=length(allpara)
if(setalpha0.to.0==TRUE){
part3.results=.part3noa0(beta=beta,par=par.set,
                      y=y,sv=sv,w=w,xs=xs,z=z,prt1_1=prt1_1,
                      alpha.1.1=alpha.1.1,prw1_1=prw1_1,len.xs=len.xs,len.sv=len.sv,len.z=len.z,
                      no.par.one=no.par.one,
                      no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)
} else if (setalpha1.to.0==TRUE){
part3.results=.part3noa1(beta=beta,par=par.set,
                      y=y,sv=sv,w=w,xs=xs,z=z,prt1_1=prt1_1,alpha.0.1=alpha.0.1,
                      prw1_1=prw1_1,len.xs=len.xs,len.sv=len.sv,len.z=len.z,
                      no.par.one=no.par.one,
                      no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)
...
#Run function part4
if(setalpha0.to.0==TRUE){
part4.results=.part4noa0(mid.term.1=mid.term.1,y=y,sv=sv,w=w,xs=xs,z=z,
                       allpara=allpara,len.xs=len.xs,len.sv=len.sv,len.z=len.z,no.par.one=no.par.one,
                       no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)
} else if (setalpha1.to.0==TRUE){
part4.results=.part4noa1(mid.term.1=mid.term.1,y=y,sv=sv,w=w,xs=xs,z=z,
                      allpara=allpara,len.xs=len.xs,len.sv=len.sv,len.z=len.z,no.par.one=no.par.one,
                      no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)
} else {
part4.results=.part4(mid.term.1=mid.term.1,y=y,sv=sv,w=w,xs=xs,z=z,
                      allpara=allpara,len.xs=len.xs,len.sv=len.sv,len.z=len.z,no.par.one=no.par.one,
                      no.par.two=no.par.two,n=n,capm=capm,nallpara=nallpara)
}
...
cat("Now calculating the confidence intervals and p-values with an alpha=",alpha," level of significance.","\n",sep="")
#Create labels for results
param.labels=c("w",betanames.z)

#Calculate results for tables 
if (setalpha0.to.0==TRUE) {
final.results=.finalpartnoa0(par.set=par.set,beta=beta,no.par.one=no.par.one,
                          par.sd=par.sd,var.cov=var.cov,alpha=alpha,
                          param.labels=param.labels,n.allpar=n.allpar)
} else if (setalpha1.to.0==TRUE){  
final.results=.finalpartnoa1(par.set=par.set,beta=beta,no.par.one=no.par.one,
                          par.sd=par.sd,var.cov=var.cov,alpha=alpha,
                          param.labels=param.labels,n.allpar=n.allpar)
} else {
...
cat("The estimation of parameters and standard errors is complete.","\n")
cat("\n")
...
return(list(two.step.results=final.results,naive.results=outw.results))
