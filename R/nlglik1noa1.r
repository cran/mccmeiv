#Begin file
.part1noa1 <- function(no.cases, no.controls.per.set, y,sv,w,xs,z,startingvalues,len.xs,len.sv,len.z,no.par.one,no.par.two,n,capm,nallpara ){
...
nlglik_1=function(par){
  ...
  #
  # prw.1=pr(W=1|X^*, Z)
  prw1_1=alpha.0.1+(1-alpha.0.1)*prt1_1
...
#End of function
return(list(prt1_1=prt1_1,alpha.0.1=alpha.0.1,prw1_1=prw1_1,pars2=par2,
