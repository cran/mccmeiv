.m4noa0=function(capm, y,sv,w,xs,z,len.xs,len.sv,len.z, no.par.one,no.par.two,startingvalues,naive.estimate.beta){
  ##
  ## Our proposed method 
  ...
  nlglikm4=function(par){
    ...
    prw1.0=(1-alpha.1.1)*prt1.0
    prw1.1=(1-alpha.1.1)*prt1.1
